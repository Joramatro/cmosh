	...
	<div id="copyright">
		...
		<div class="container">
			...
			<div class="span12">
				...
				&copy; <fmt:formatDate value="${date}" pattern="yyyy" />,&nbsp;<a target="_blank" href="https://www.google.com/+Comprarmovileshoy"><span id="_publisher8" itemscope itemtype="http://schema.org/Organization">
